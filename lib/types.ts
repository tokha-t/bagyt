...
export type Field =
  | 'it' | 'medicine' | 'engineering' | 'business' | 'law' | 'design'
  | 'education' | 'science' | 'humanities' | 'media' | 'agriculture' | 'undecided';
...
export type BudgetBand = 'grant-only' | 'under-1m' | '1-3m' | '3-6m' | 'over-6m';
export type Region = 'my-city' | 'kazakhstan' | 'central-asia' | 'turkiye' | 'europe' | 'asia' | 'any';
...
export type DimensionKey =
  | 'academic' | 'financial' | 'language' | 'field' | 'geography' | 'timing';
...
export interface TaskTemplate {
  ...
  title: string;
  why: string;
  anchor: 'untWindowStart' | 'documentsOpen' | 'applicationDeadline' | 'intakeStart';
